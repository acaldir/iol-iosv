    ...
    try:
        ...
        for satir_numarasi, satir in enumerate(lines, 1):
            ...
            if is_router1 and is_router2:
                ...
                x = min(id1, id2)  # Küçük ID → x
                y = max(id1, id2)  # Büyük  ID → y
            ...
            # Ansible Verileri (Sadece Routerlar)
